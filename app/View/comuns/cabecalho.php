...
<head>
  ...
  <link rel="stylesheet" href="<?= baseUrl()?>assets/css/app.css"><!-- nosso tema -->
  
  <!-- DataTables (continua igual) -->
  <link rel="stylesheet"
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0 gap-lg-3">
            ...
            <li class="nav-item">
              <a class="nav-link text-primary fw-semibold" href="#">Quem Somos</a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-primary fw-semibold" href="#">Produtos/Serviços</a>
            </li>
            ...
            <?php if (Session::get('userId')): ?>
              ...
              <?php if ($nivel === 31): ?>
                <li class="nav-item">
                  <a class="nav-link text-primary fw-semibold" href="<?= baseUrl()?>sistema">
                    Meus Projetos
                  </a>
                </li>
              <?php endif; ?>
              ...
              <?php if ($nivel <= 21): ?>
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu border-0 rounded shadow-sm">
                    ...
                    <?php if ($nivel <= 11): ?>
                      <li><a class="dropdown-item" href="<?= baseUrl()?>projeto/form/insert/0">
                        Novo
                      </a></li>
                    <?php endif; ?>
                    <li><hr class="dropdown-divider"></li>
                    <li><a class="dropdown-item" href="<?= baseUrl()?>reuniao">
                      Reuniões
                    </a></li>
                    <li><a class="dropdown-item" href="<?= baseUrl()?>entrega">
                      Entregas
                    </a></li>
                  </ul>
                </li>
              ...
              <?php if ($nivel <= 11): ?>
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu border-0 rounded shadow-sm">
                    <li><a class="dropdown-item" href="<?= baseUrl()?>professor">
                      Professores
                    </a></li>
                    <li><a class="dropdown-item" href="<?= baseUrl()?>aluno">
                      Alunos
                    </a></li>
                  </ul>
                </li>
          ...
          <ul class="navbar-nav align-items-lg-center gap-lg-3">
            ...
            <?php else: ?>
              <li class="nav-item">
                <a class="btn btn-outline-primary fw-semibold" href="<?= baseUrl() ?>login">
                  Área restrita
                </a>
              </li>
            <?php endif; ?>
